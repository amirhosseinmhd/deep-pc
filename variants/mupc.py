"""μPC variant — MLP with skip connections and μPC parameterisation."""
...
class MuPCVariant:
    """PC network using jpc.make_mlp + jpc.make_skip_model with μPC scaling."""
    ...
    def init_activities(self, bundle, x_batch):
        activities = jpc.init_activities_with_ffwd(
            ...
            skip_model=bundle["skip_model"], param_type="mupc",
        )
