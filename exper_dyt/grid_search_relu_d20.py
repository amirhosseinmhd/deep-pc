"""Grid search over (param_lr, activity_lr) for DyT relu depth=20."""
import os
...
from common_dyt import (
    FCResNetDyT, train_dyt_and_record, ensure_dir, set_seed,
    INPUT_DIM, OUTPUT_DIM, WIDTH, SEED, BATCH_SIZE, TEST_EVERY,
    DYT_RESULTS_DIR,
)

save_dir = ensure_dir(os.path.join(DYT_RESULTS_DIR, "grid_search"))
...
# ================================================================
print("\n" + "=" * 70)
print("GRID SEARCH RESULTS — DyT relu depth=20")
print("=" * 70)
